...
import { contextualBarBounds, contextualBarOverlays, layoutWidth } from '@/lib/resize';
...
export const ContextualBar = ({
  ...
  return (
    <aside
      ...
      style={overlay ? undefined : { width: open ? width : 0 }}
      aria-label={title}
      className={cn(
        ...
        overlay
          ? // Over the room rather than beside it, filling the space the
            ...
            'absolute inset-0 z-10 shadow-xl transition-opacity duration-200 motion-reduce:transition-none'
          : 'relative shrink-0',
