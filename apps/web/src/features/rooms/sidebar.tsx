...
import { layoutWidth, sidebarBounds, SIDEBAR_RAIL_WIDTH } from '@/lib/resize';
 ...
 *
 * Lives in `lib/resize` because the contextual bar reaches across it when it
 * floats, and two copies of the number would drift apart.
 */
const RAIL_WIDTH = SIDEBAR_RAIL_WIDTH;
